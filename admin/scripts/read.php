...
function getAllMoviesChild()
{
    $pdo = Database::getInstance()->getConnection();
    $queryAll = 'SELECT * FROM tbl_movies WHERE ratings <= 3';
    $results = $pdo->query($queryAll);
...
function getAllTVChild()
{
    $pdo = Database::getInstance()->getConnection();
    $queryAll = 'SELECT * FROM tbl_tv WHERE ratings <= 3';
    $results = $pdo->query($queryAll);
...
function getAllMusicChild()
{
    $pdo = Database::getInstance()->getConnection();
    $queryAll = 'SELECT * FROM tbl_music WHERE ratings <= 3';
    $results = $pdo->query($queryAll);
...
function getMoviesbyRatings($args)
{
    $pdo = Database::getInstance()->getConnection();
    ...
    $filterQuery .= ' AND t2.' . $args['col3'] . ' = "' . $args['mrfilter'] . '"';
